...
@section('title') اضافة  تبرع  @endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <label class="form-label col-lg-3">  تبرع للمريض </label>
                            <div class="col-lg-9">
                                <select class="form-control @error('order_id') is-invalid @enderror select2 " dir="rtl" name="order_id" style="width: 100%">
                                    <option ></option>
                                    @foreach($orders as $order)
                                        <option value="{{$order->id}}">{{$order->person->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
