...
@section('title') مشتقات الدم  @endsection
...
@section('content')
    @component('common-components.breadcrumb')
        @slot('pagetitle') السحب @endslot
        @slot('title')  مشتقات الدم @endslot
    @endcomponent
...
<script>
    ...
    $('#submit').on('click', function (e) {
        ...
        if($('#full_blood').is(':checked')) {
            bloods.push('الدم الكامل')
        }

        if($('#red_blood').is(':checked')) {
            bloods.push( 'الدم الاحمر')
        }
        ...
        if($('#plasma').is(':checked')) {
            bloods.push('البلازما')
        }

        if($('#frozen').is(':checked')) {
            bloods.push('الراسب المتجمد')
        }
