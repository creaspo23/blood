...
<body>
    <div class="invoice-box">
        <h1 style="text-align: center">تقرير الدم الزائد</h1>
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                الأسم : {{ $polcythemia->person->name }} <br />
                                المستشفي : {{ $polcythemia->hospital }}<br />
                                تاريخ الميلاد : {{ $polcythemia->person->birth_date }} <br />

                            </td>

                            <td style="text-align: right">
                                <span style="font-size: 15px;"> رقم الطلب:</span> <span
                                    style="font-weight: bold;">{{ $polcythemia->id }}</span><br />
                                <span style="font-size: 15px;">تاريخ الطلب :</span> <span style="font-weight: bold;">
                                    {{ \Carbon\Carbon::createFromTimestamp(strtotime($polcythemia->created_at))->format('d-m-Y') }}</span><br />
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <table dir="rtl">
            ...
            <tr class="item">
                <td style="text-align: center">{{ $polcythemia->id }}</td>
                <td style="text-align: center">{{ $polcythemia->HB }}</td>
                <td style="text-align: center">{{ $polcythemia->BP }}</td>
                <td style="text-align: center">{{ $polcythemia->status }}</td>
            </tr>
        </table>
        <table>
