            ...
            <tr class="information">
                <td colspan="2">
                    <table>
                        <tr>
                            <td>
                                <span style="font-weight: bold; font-size: 20px; "> فحوصات المتبرعين</span> <br />
            ...
            <table id="keywords" cellspacing="0" cellpadding="0">
                <thead>
                    <tr style="margin-bottom: 40px;">
                        <th colspan="2" style="text-align: center"><span>HCV</span></th>
                        <th colspan="2"style="text-align: center"><span>HBV</span></th>
                        <th colspan="2"style="text-align: center"><span>HIV</span></th>
                        <th colspan="2"style="text-align: center"><span>SYPHILIS</span></th>
                    </tr>
                    <tr >
                ...
                <tbody>
                    <tr>
                        <td colspan="1" style="text-align: center">{{$HCV}}</td>
                        <td style="text-align: center">{{$index - $HCV}}</td>
                        <td colspan="1"style="text-align: center">{{$HBV}}</td>
                        <td style="text-align: center">{{$index - $HBV}}</td>

                        <td colspan="1" style="text-align: center">{{$HIV}}</td>
                        <td style="text-align: center">{{$index - $HIV}}</td>

                        <td colspan="1" style="text-align: center">{{$SYPHILIS}}</td>
                        <td style="text-align: center">{{$index - $SYPHILIS}}</td>
