...
<body>
    <div class="invoice-box">
        ...
        <div>
            <div id="wrapper">
                <h2 dir="rtl"style="margin-bottom:40px;text-align:right"> جدول يوضح مرضي زياده الدم </h2>
            ...
            <div id="wrapper">
                <h3 dir="rtl"style="margin-bottom:30px">  جدول يوضح إقتصاد داخل السلاح </h3>
            ...
            <div id="wrapper">
                <h3 dir="rtl"style="margin-bottom:30px">  جدول يوضح إقتصاد خارج السلاح</h3>
